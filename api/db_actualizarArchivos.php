...
if($data['sacep']=='sacepDc'){
    ...
    imagedestroy($img);
    $query = mysqli_query($connection, "UPDATE tb_sacep_documentacion_docente SET 
        archivo_documento='$directory' WHERE id_doc_docente='$data[id_doc_docente]'");
}
if($query){
