...
if ($postjson['aksi'] == "estudiante"){
    $data = array();
    $query = mysqli_query($connection, "SELECT *, tb_sacep_rol.descripcion_rol FROM tb_sacep_usuario, tb_sacep_rol where tb_sacep_usuario.id_rol = 2 and tb_sacep_usuario.id_rol = tb_sacep_rol.id_rol ORDER BY id_usuario ASC");
