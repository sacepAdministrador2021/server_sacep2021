...
if ($postjson['aksi'] == "operadores"){
    $data = array();
    $query = mysqli_query($connection, "select tb_sacep_operadores.*, tb_sacep_rol.descripcion_rol, tb_sacep_status.tipo_status from tb_sacep_operadores, tb_sacep_rol, tb_sacep_status where tb_sacep_rol.id_rol = tb_sacep_operadores.id_rol and tb_sacep_status.id_status = tb_sacep_operadores.id_status");
    ...
    while($row = mysqli_fetch_array($query)){
        $data[] = array(
            ...
            'contrasena_operador' => $row['contrasena_operador'],
